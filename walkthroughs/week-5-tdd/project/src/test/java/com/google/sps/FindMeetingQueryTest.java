...
public final class FindMeetingQueryTest {
  ...
  public void everyAttendeeIsConsideredv2() {
     Collection<Event> events = Arrays.asList(
        new Event("Event 0", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TimeRange.END_OF_DAY, true),
  ...
  @Test
  public void everyAttendeeIsConsideredv3() {
     Collection<Event> events = Arrays.asList(
        new Event("Event 0", TimeRange.fromStartDuration(TIME_0830AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_C)),
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
  ...
  public void justEnoughRoomv2() {
    ...
    Collection<Event> events = Arrays.asList(
        new Event("Event 0", TimeRange.fromStartEnd(TIME_0830AM, TIME_0845AM, false),
            Arrays.asList(PERSON_B)),      
        new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0830AM, false),
            Arrays.asList(PERSON_A)),      
        new Event("Event 2", TimeRange.fromStartEnd(TIME_0900AM, TimeRange.END_OF_DAY, true),
  ...
  @Test
  public void onlyOptionalsWholeDay() {
  ...
  /*@Test
  public void getAsManyOptionals() {
    //If no time exists for all optional and mandatory attendees, find the time slot(s) 
    //that allow mandatory attendees and the greatest possible number of optional 
    //attendees to attend.
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0800AM, false),
            Arrays.asList(PERSON_A)),
        new Event("Event 3", TimeRange.fromStartEnd(TIME_0800AM, TIME_0900AM, false),
            Arrays.asList(PERSON_C)),
        new Event("Event 3", TimeRange.fromStartEnd(TIME_0800AM, TIME_0900AM, false),
